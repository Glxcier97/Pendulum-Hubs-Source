...
local hat = Align(char['Type-9000 Minigun'].Handle,char['Right Arm'],false)
local cf = char['Right Arm'].CFrame*CFrame.new(0,-0.75,-2.5)*CFrame.Angles(math.rad(-346734673764376467346736840),math.rad(30),0)
